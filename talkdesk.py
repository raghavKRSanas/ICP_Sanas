...
# Virtual Audio Cable device ID
vac_device_id = int(index)  # Device ID for "Line 1 (Virtual Audio Cable)" (change this to the appropriate ID)
time.sleep(15)
vj.play_audio_files_to_vac(wav_files, vac_device_id)
print("audio played")
iframeHandler(driver, title='Conversations')
time.sleep(5)
