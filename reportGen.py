...
def generate_html_report_with_comments(data1, data2, comments, model1, model2):
...
def main(data1, data2, comments, model1, model2):
    # Generate the report with comments
    report_content = generate_html_report_with_comments(data1, data2, comments, model1, model2)
